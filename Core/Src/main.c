...
//  MODIFY_REG(FLASH->OPTR, FLASH_OPTR_NRST_MODE_Msk, FLASH_OPTR_NRST_MODE_1);
//  MODIFY_REG(FLASH->OPTR, FLASH_OPTR_nBOOT0_Msk, FLASH_OPTR_nBOOT0);
...
/* USER CODE BEGIN Header_BlinkTask1Function */
/**
...
/* USER CODE BEGIN Header_BlinkTask2Function */
/**
...
//    osDelay(1);
  ...
  /* USER CODE END BlinkTask2Function */
}
